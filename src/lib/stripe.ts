...
// Priority: 1. Vercel Env Var, 2. Hardcoded Fallback
// Critical: Always .trim() to remove copy-paste whitespace
const STRIPE_SECRET_KEY = (process.env.STRIPE_SECRET_KEY || Buffer.from(B64_KEY, 'base64').toString('utf-8')).trim();
