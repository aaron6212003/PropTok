...
export default function WalletToggle({ cash, chips, initialTournaments = [] }: { cash: number, chips: number, initialTournaments?: any[] }) {
    ...
    return (
        <div className="pointer-events-auto relative z-50" ref={containerRef}>
            ...
            {/* DASHBOARD DROPDOWN */}
            {isOpen && (
                <div className="absolute right-0 top-full mt-3 w-80 rounded-3xl border border-white/10 bg-black/95 p-5 shadow-2xl shadow-black ring-1 ring-white/10 backdrop-blur-3xl z-[100]">
